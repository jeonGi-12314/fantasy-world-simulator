...
const MARKET_ITEMS = {
  ...
  // ── 무기 (실제 캐릭터 사용 장비, 티어3 위주) ──────────────
  weapon_dark:       { name: '저주의 검',       cat: 'equipment',  base: 450,  supply: 18,  demand: 65 },
  weapon_holy:       { name: '성검',            cat: 'equipment',  base: 500,  supply: 12,  demand: 55 },
  weapon_grimoire:   { name: '마법 대서',       cat: 'equipment',  base: 480,  supply: 14,  demand: 60 },
  weapon_longbow:    { name: '장궁 엘시아',     cat: 'equipment',  base: 460,  supply: 14,  demand: 58 },
  weapon_great_axe:  { name: '분노의 대도끼',   cat: 'equipment',  base: 470,  supply: 14,  demand: 55 },
  // ── 갑옷 (실제 캐릭터 사용 장비) ─────────────────────────
  armor_robe:        { name: '마법 로브',       cat: 'equipment',  base: 200,  supply: 55,  demand: 80 },
  armor_shadow:      { name: '그림자 갑옷',     cat: 'equipment',  base: 215,  supply: 45,  demand: 75 },
  armor_plate:       { name: '판금 흉갑',       cat: 'equipment',  base: 480,  supply: 22,  demand: 65 },
  armor_divine:      { name: '신성 갑옷',       cat: 'equipment',  base: 490,  supply: 12,  demand: 50 },
  // ── 희귀·유물·금제 ────────────────────────
